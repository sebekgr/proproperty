...
export const Grid = styled.div<Props>`
  ...
  grid-auto-rows: auto;
  gap: ${(props) => (props.gapDefault ? props.gapDefault : `${size.s} ${size.s}`)};
  margin: ${(props) => (props.marginDefault ? props.marginDefault : 0)};

  @media ${breakpoint.m} {
    grid-template-columns: 2rem repeat(6, 1fr) 2rem;
    gap: ${(props) => (props.gapMedium ? props.gapMedium : `${size.xs} ${size.xs}`)};
    margin: ${(props) => (props.marginMedium ? props.marginMedium : 0)};
  }

  @media ${breakpoint.s} {
    grid-template-columns: 1rem repeat(6, 1fr) 1rem;
    gap: ${(props) => (props.gapSmall ? props.gapSmall : `${size.xs} ${size.xs}`)};
...
export const FullWidthSection = styled.section<Props>`
  ...
  @media ${breakpoint.s} {
    grid-template-columns: 1rem repeat(6, 1fr) 1rem;
    gap: ${(props) => (props.gapSmall ? props.gapSmall : `${size.s} ${size.s}`)};
    margin: ${(props) => (props.marginSmall ? props.marginSmall : 0)};
  }
`;
